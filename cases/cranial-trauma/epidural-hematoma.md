...
- Mayfield or horseshoe (horseshoe if speed critical)
...
### Key Surgical Steps
1. **Rapid incision and craniotomy** — speed is critical
2. **Craniotomy centered over the EDH** — must be large enough to evacuate all clot
3. **Evacuate clot** — suction and irrigation; clot is usually organized/solid
4. **Identify bleeding source:**
   - **Middle meningeal artery** (most common for temporal EDH) — coagulate with bipolar or ligate; may need to drill out foramen spinosum with diamond burr and pack with bone wax
   - **Dural venous sinus** (for posterior fossa or vertex EDH) — Surgicel/Gelfoam packing
   - **Diploic veins** — bone wax
   - **Dural surface bleeding** — bipolar, Surgicel
5. **Tacking sutures** — multiple dural tacking sutures to inner table to prevent re-accumulation
6. **Inspect dura** — if dura is blue/tense, may have underlying SDH or contusion (open if indicated)
7. **Replace bone flap** — EDH patients typically do NOT need craniectomy (brain is usually not swollen)
8. **Consider drain** — epidural or subgaleal

### Critical Anatomy
1. **Middle meningeal artery** — in the temporal bone groove; most common EDH source
2. **Dural venous sinuses** — sagittal sinus, transverse sinus (vertex or posterior fossa EDH)
3. **Temporal lobe** — may be compressed but usually not contused
...
**Preoperative Diagnosis:** Acute [left/right] [temporal] epidural hematoma

**Postoperative Diagnosis:** Same

**Procedure:** Emergent [left/right] [temporal/frontotemporal] craniotomy for evacuation of epidural hematoma

[Include: clot description (organized, volume), bleeding source identified and controlled, dural tacking sutures, bone flap replaced, drain if placed]

---

## Postoperative Plan
- [ ] ICU monitoring x 24h
- [ ] Neuro checks q1h
...
- [ ] Seizure prophylaxis x 7 days
- [ ] DVT prophylaxis
- [ ] Follow-up CT before discharge
